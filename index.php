...
echo "    <button type=\"button\" class=\"navbar-toggle\" data-toggle=\"collapse\" data-target=\".navbar-bootsnipp-collapse\">\n";
echo "      <i class='glyphicon glyphicon-th'><span class=\"sr-only\">Toggle navigation</span>\n";
echo "      <span class=\"icon-bar\"></span>\n";
echo "      <span class=\"icon-bar\"></span>\n";
echo "      <span class=\"icon-bar\"></span>\n";
echo "   </i></button>\n";
echo "  <span class='visible-xs navbar-brand'>"._('Sub-Menu')."</span>";
echo " </div>";
}
